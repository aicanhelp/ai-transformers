...
from ..train.trainer import TaskTrainer, set_seed
from ..train.trainer_utils import TaskPredictionOutput, TaskEvalPrediction
from ..train.training_args import TaskTrainingArguments
from ..data import TaskDataArguments, TaskDataset, TaskDataProcessor
...
class TaskModel:
    def __init__(self, modelArgs: TaskModelArguments, model_class=None):
    ...
    def compute_metrics(self, p: TaskEvalPrediction) -> Dict:
...
class TaskData:
    def __init__(self, dataArgs: TaskDataArguments,
                 tokenizer, dataProcessor: TaskDataProcessor, local_rank):
...
class TaskTrainer:
    def __init__(self, trainingArgs: TaskTrainingArguments,
    ...
    def predict(self, test_dataset: Dataset = None) -> TaskPredictionOutput:
...
class TransformerTask:
    ...
    def predict(self) -> TaskPredictionOutput:
